...
from powerbank.urls.auth_urls import rest_auth_urls
from powerbank.urls.swagger_urls import swagger_urlpatterns
from powerbank.urls.versioned_urls import versioned_urls
