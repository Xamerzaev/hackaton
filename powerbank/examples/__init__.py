from powerbank.examples.auth_requests import (
    user_login_curl,
    user_logout_curl,
...
from powerbank.examples.auth_responses import (
...
from powerbank.examples.user_requests import profile_update_curl
from powerbank.examples.user_responses import (
